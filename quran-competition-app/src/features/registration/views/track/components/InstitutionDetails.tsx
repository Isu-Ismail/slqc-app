                    ...
                    <div className={styles.detailsFormGrid} style={{ marginBottom: '16px', gap: '10px' }}>
                        ...
                        <div className={styles.formGroup} style={{ position: 'relative' }}>
                            ...
                            <input
                                ...
                                maxLength={6}
                            />
                            {isLoadingLocation && <small style={{ color: '#0d9488', position: 'absolute', top: '100%', left: '4px', fontSize: '11px', fontWeight: '500' }}>⚡ Fetching details...</small>}
                            {pincodeError && <small style={{ color: '#ef4444', position: 'absolute', top: '100%', left: '4px', fontSize: '11px', fontWeight: '500' }}>{pincodeError}</small>}
                        </div>
                                ...
                                <ul style={{
                                    ...
                                    {filteredVillages.map((village, idx) => (
                                        <li
                                            ...
                                            style={{ padding: '8px 12px', cursor: 'pointer', borderRadius: '4px', color: '#1e293b', fontSize: '13px' }}
