                        ...
                        {leaderboard.length > 0 && leaderboard.some(item => !item.is_frozen) && !leaderboard.some(item => item.is_finalist) ? (
                            ...
                            <div className={styles.warningContainer}>
                                ...
                                <p className={styles.warningText}>
                                    Leaderboard and finalist promotion will be available once the preliminary round scores for all present candidates in the <strong>{selectedCategory.replace('_', ' ')}</strong> category are entered and locked.
                                </p>
